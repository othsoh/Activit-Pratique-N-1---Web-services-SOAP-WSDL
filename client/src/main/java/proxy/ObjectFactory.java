...
public class ObjectFactory {
    ...
    private static final QName _Convertir_QNAME = new QName("http://bank_webservice.bank.ws/", "Convertir");
    private static final QName _ConvertirResponse_QNAME = new QName("http://bank_webservice.bank.ws/", "ConvertirResponse");
    private static final QName _GetAccount_QNAME = new QName("http://bank_webservice.bank.ws/", "getAccount");
    private static final QName _GetAccountResponse_QNAME = new QName("http://bank_webservice.bank.ws/", "getAccountResponse");
    private static final QName _GetAccounts_QNAME = new QName("http://bank_webservice.bank.ws/", "getAccounts");
    private static final QName _GetAccountsResponse_QNAME = new QName("http://bank_webservice.bank.ws/", "getAccountsResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://bank_webservice.bank.ws/", name = "Convertir")
     ...
     */
    @XmlElementDecl(namespace = "http://bank_webservice.bank.ws/", name = "ConvertirResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://bank_webservice.bank.ws/", name = "getAccount")
     ...
     */
    @XmlElementDecl(namespace = "http://bank_webservice.bank.ws/", name = "getAccountResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://bank_webservice.bank.ws/", name = "getAccounts")
     ...
     */
    @XmlElementDecl(namespace = "http://bank_webservice.bank.ws/", name = "getAccountsResponse")
